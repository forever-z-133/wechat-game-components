...
export default class UserPage extends Block {
  constructor() {
    ...
    this.addChild('_mainTitle', _mainTitle);
    // 返回按钮
    const _btnBack = new Img(imgSrc.back, px(95), px(140), px(60), px(60));
    this.addChild('_btnBack', _btnBack);
    ...
    this.addChild('_userClothes', _userClothes);
    this.addChild('_userThings', _userThings);
    this.addChild('_userHistory', _userHistory);
    ...
    tabConfig.forEach((item, index) => {
      ...
      new Array(2).fill().forEach((x, i) => {
        ...
        _tabBlock.addChild('_tab' + index + i, _tab);
    ...
    this.addChild('_tabBlock', _tabBlock);
